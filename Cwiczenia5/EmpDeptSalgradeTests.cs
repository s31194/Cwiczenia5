...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        Assert.Equal(30, result[0].DeptNo);
        Assert.Equal(30, result[1].DeptNo);
    }
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        Assert.Contains(result, r => r.DeptNo == 20 && r.AvgSal > 500);
        Assert.Contains(result, r => r.DeptNo == 10 && r.AvgSal > 4000);
    }
